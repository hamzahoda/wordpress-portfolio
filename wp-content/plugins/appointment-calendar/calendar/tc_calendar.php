...
if(file_exists("calendar/calendar.js")) { ?> 
	<script language="javascript" src="calendar/calendar.js"></script> <?php 
...
class tc_calendar{
	...
	function writeCalendarContainer(){
		...
		echo("<div id=\"div_".$this->objname."\" style=\"position:".$div_position.";visibility:".$div_display.";z-index:100;".$div_align.";margin-left:".$margin_left."\" class=\"div_calendar calendar-border\" ".$mout_str." ".$mover_str.">");

		echo("<IFRAME id=\"".$this->objname."_frame\" src=\"".$this->path."calendar_form.php".$paramStr."\" frameBorder=\"0\" scrolling=\"no\" allowtransparency=\"true\" width=\"250px\" height=\"100%\" style=\"z-index: 100;height:201px;\" margin-left=$margin_left></IFRAME>");
		echo("</div>");	
	...
	function writeHidden(){
		...
		$checkhttp = strstr($this->path, 'https');
		if($protocol == "https" && !$checkhttp)
		{
			$this->path = str_replace("http", $protocol, $this->path);
		}
