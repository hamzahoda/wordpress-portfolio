...
$hl = ( isset( $_REQUEST["hl"] ) ) ? filter_var($_REQUEST["hl"], FILTER_SANITIZE_STRING ) : false;
$show_not_allow = (isset( $_REQUEST["sna"] ) ) ? filter_var($_REQUEST["sna"], FILTER_SANITIZE_STRING ) : true;
$auto_submit = (isset( $_REQUEST["aut"] ) ) ? filter_var($_REQUEST["aut"], FILTER_SANITIZE_STRING ) : false;
...
$sld = ( isset( $_REQUEST["selected_day"] ) ) ? filter_var($_REQUEST["selected_day"], FILTER_SANITIZE_STRING) : 0;
$slm = ( isset( $_REQUEST["selected_month"] ) ) ? filter_var($_REQUEST["selected_month"], FILTER_SANITIZE_STRING) : 0;
$sly = ( isset( $_REQUEST["selected_year"] ) ) ? filter_var($_REQUEST["selected_year"], FILTER_SANITIZE_STRING) : 0;
$year_start = ( isset( $_REQUEST["year_start"] ) ) ? filter_var($_REQUEST["year_start"], FILTER_SANITIZE_STRING) : 0;
$year_end = (isset( $_REQUEST["year_end"] ) ) ? filter_var($_REQUEST["year_end"], FILTER_SANITIZE_STRING) : 0;
$startDate = (isset( $_REQUEST["str"] ) ) ? filter_var($_REQUEST["str"], FILTER_SANITIZE_STRING ) : 0;
$time_allow1 = (isset( $_REQUEST["da1"] ) ) ? filter_var($_REQUEST["da1"], FILTER_SANITIZE_STRING) : "";
$time_allow2 = (isset( $_REQUEST["da2"] ) ) ? filter_var($_REQUEST["da2"], FILTER_SANITIZE_STRING) : "";
$ta1_set = is_numeric($time_allow1);
$ta2_set = is_numeric($time_allow2);
$form_name = (isset( $_REQUEST["frm"] ) ) ? filter_var($_REQUEST["frm"], FILTER_SANITIZE_STRING ) : "";
$target_url = (isset( $_REQUEST["tar"] ) ) ? filter_var($_REQUEST["tar"], FILTER_SANITIZE_STRING ) : "";
$show_input = (isset( $_REQUEST["inp"] ) ) ? filter_var($_REQUEST["inp"], FILTER_SANITIZE_STRING ) : true;
$date_format = (isset( $_REQUEST["fmt"] ) ) ? filter_var($_REQUEST["fmt"], FILTER_SANITIZE_STRING ) : DATE_FORMAT; //format of date shown in panel if $show_input is false
$dsb_txt = (isset( $_REQUEST["dis"] ) ) ? filter_var($_REQUEST["dis"], FILTER_SANITIZE_STRING ) : "";
$date_pair1 = (isset( $_REQUEST["pr1"] ) ) ? filter_var($_REQUEST["pr1"], FILTER_SANITIZE_STRING ) : "";
$date_pair2 = (isset( $_REQUEST["pr2"] ) ) ? filter_var($_REQUEST["pr2"], FILTER_SANITIZE_STRING ) : "";
$date_pair_value = (isset( $_REQUEST["prv"] ) ) ? filter_var($_REQUEST["prv"], FILTER_SANITIZE_STRING ) : "";
$path = (isset( $_REQUEST["pth"] ) ) ? filter_var($_REQUEST["pth"], FILTER_SANITIZE_STRING ) : "";
$sp_dates = (isset( $_REQUEST["spd"] ) ) ? @tc_calendar::check_json_decode( filter_var($_REQUEST["spd"], FILTER_SANITIZE_STRING ) ) : array(array(), array(), array());
$sp_type = (isset( $_REQUEST["spt"] ) ) ? filter_var($_REQUEST["spt"], FILTER_SANITIZE_STRING) : 0;
$tc_onchanged = (isset( $_REQUEST["och"] ) ) ? filter_var($_REQUEST["och"], FILTER_SANITIZE_STRING ) : "";
$rtl = (isset($_REQUEST["rtl"])) ? filter_var($_REQUEST["rtl"], FILTER_SANITIZE_STRING ) : RTL;
$show_weeks = (isset($_REQUEST["wks"])) ? filter_var($_REQUEST["wks"], FILTER_SANITIZE_STRING) : false;
$interval = (isset($_REQUEST["int"])) ? filter_var($_REQUEST["int"], FILTER_SANITIZE_STRING) : 1;
$auto_hide = (isset($_REQUEST["hid"])) ? filter_var($_REQUEST["hid"], FILTER_SANITIZE_STRING) : 0;
$auto_hide_time = (isset($_REQUEST["hdt"])) ? filter_var($_REQUEST["hdt"], FILTER_SANITIZE_STRING) : 1000;
$hl = (isset($_REQUEST["hl"])) ? filter_var($_REQUEST["hl"], FILTER_SANITIZE_STRING ) : 'en_US';
...
if(isset($_REQUEST["y"]))
	$y = filter_var($_REQUEST["y"], FILTER_SANITIZE_STRING);
else
	$y = ($cyr) ? $sly : date('Y');
...
$objname = (isset($_REQUEST["objname"])) ? filter_var($_REQUEST["objname"], FILTER_SANITIZE_STRING ) : "";
$dp = (isset($_REQUEST["dp"])) ? filter_var($_REQUEST["dp"], FILTER_SANITIZE_STRING ) : "";
