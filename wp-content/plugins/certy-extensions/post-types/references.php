...
if ( ! function_exists('certy_references') ) {

// Register Custom Post Type
    function certy_references() {

        $labels = array(
            'name'                  => _x( 'References Items', 'Post Type General Name', CERTY_EXTENSIONS_TEXT_DOMAIN ),
            'singular_name'         => _x( 'References', 'Post Type Singular Name', CERTY_EXTENSIONS_TEXT_DOMAIN ),
            'menu_name'             => __( 'References', CERTY_EXTENSIONS_TEXT_DOMAIN ),
            'name_admin_bar'        => __( 'References', CERTY_EXTENSIONS_TEXT_DOMAIN ),
            'archives'              => __( 'References Archives', CERTY_EXTENSIONS_TEXT_DOMAIN ),
            'attributes'            => __( 'References Attributes', CERTY_EXTENSIONS_TEXT_DOMAIN ),
        ...
        $args = array(
            'label'                 => __( 'References', CERTY_EXTENSIONS_TEXT_DOMAIN ),
            'description'           => __( 'References Post Type For Certy Theme', CERTY_EXTENSIONS_TEXT_DOMAIN ),
            'labels'                => $labels,
        ...
        register_post_type( 'certy_references', $args );

    }
    add_action( 'init', 'certy_references', 0 );

}

if ( ! function_exists( 'certy_references_category' ) ) {

// Register Custom Taxonomy
    function certy_references_category() {
        ...
        register_taxonomy( 'certy_references_category', array( 'certy_references' ), $args );

    }
    add_action( 'init', 'certy_references_category', 0 );
