...
if ( ! function_exists('certy_timeline') ) {

// Register Custom Post Type
    function certy_timeline() {

        $labels = array(
            'name'                  => _x( 'Timeline Items', 'Post Type General Name', CERTY_EXTENSIONS_TEXT_DOMAIN ),
            'singular_name'         => _x( 'Timeline', 'Post Type Singular Name', CERTY_EXTENSIONS_TEXT_DOMAIN ),
            'menu_name'             => __( 'Timeline', CERTY_EXTENSIONS_TEXT_DOMAIN ),
            'name_admin_bar'        => __( 'Timeline', CERTY_EXTENSIONS_TEXT_DOMAIN ),
            'archives'              => __( 'Timeline Archives', CERTY_EXTENSIONS_TEXT_DOMAIN ),
            'attributes'            => __( 'Timeline Attributes', CERTY_EXTENSIONS_TEXT_DOMAIN ),
        ...
        $args = array(
            'label'                 => __( 'Timeline', CERTY_EXTENSIONS_TEXT_DOMAIN ),
            'description'           => __( 'Timeline Post Type For Certy Theme', CERTY_EXTENSIONS_TEXT_DOMAIN ),
            'labels'                => $labels,
        ...
        register_post_type( 'certy_timeline', $args );

    }
    add_action( 'init', 'certy_timeline', 0 );

}

if ( ! function_exists( 'certy_timeline_category' ) ) {

// Register Custom Taxonomy
    function certy_timeline_category() {
        ...
        register_taxonomy( 'certy_timeline_category', array( 'certy_timeline' ), $args );

    }
    add_action( 'init', 'certy_timeline_category', 0 );
